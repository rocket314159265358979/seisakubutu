...
const BlockList = [
    { id: "地球", color: "green" },
    { id: "水", color: "blue" },
    { id: "川", color: "mediumblue" },
    { id: "海", color: "darkcyan"},
    { id: "大海", color: "darkslateblue"},
    { id: "太平洋", color: "darkblue"},
    { id: "大西洋", color: "midnightblue"},
...
// レシピ: 合体の条件
const recipes = [
    { gradient1: "水", gradient2: "水", result: "川" },
    { gradient1: "水", gradient2: "川", result: "海" },
    { gradient1: "海", gradient2: "川", result: "大海"},
    { gradient1: "大海", gradient2: "海", result: "太平洋"},
    { gradient1: "大海", gradient2: "川", result: "大西洋"},
    { gradient1: "太平洋", gradient2: "大西洋", result: "地球"},
    { gradient1: "地球", gradient2: "地球", result:  "溶岩"},
    { gradient1: "", gradient2: "", result:  ""},
    { gradient1: "", gradient2: "", result:  ""},
    { gradient1: "", gradient2: "", result:  ""}
];
...
document.addEventListener("keydown", (e) => {
    if (e.code === "Space" && canAddBlock) {
        // 赤ブロックを生成
        const newBlock = new Block("水", mouseX - 25, mouseY - 25);
